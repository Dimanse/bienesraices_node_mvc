...
const emailRegistro = async (datos) => {
    const transport = nodemailer.createTransport({
      ...
      await transport.sendMail({
        ...
        to: email,
        subjet: 'Confirma tu Cuenta en BienesRaices.com',
        text: 'Confirma tu Cuenta en BienesRaices.com',
        html: `
          <p>Hola ${nombre}, estas a punto de finalizar tu registro en BienesRaices.com</p>
...
const emailOlvidePassword = async (datos) => {
  const transport = nodemailer.createTransport({
    ...
    from: 'BienesRaices.com',
    to: email,
    subjet: 'Restablece tu password en BienesRaices.com',
    ...
    html: `
        ...
        <a href="${process.env.BACKEND_URL}:${process.env.PORT ?? 3000}/auth/olvidePassword/${token}">Restablece tu password</a></p>
